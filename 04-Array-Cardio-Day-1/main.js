...
// from this link => https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
...
const transportation = data.reduce(function(obj, item) {
  // sets the count to zero and dynamically 
  // looks up the item name instead of hard-coding
  if (!obj[item]) {
    obj[item] = 0;
  }
  // increments the count for each item previously initialized
  obj[item]++;
  return obj;
}, {});
